...
namespace HttpStatus {
	...
	inline bool isInformational(Code code) {return isInformational(static_cast<int>(code));}
	inline bool isSuccessful(Code code) {return isSuccessful(static_cast<int>(code));}
	inline bool isRedirection(Code code) {return isRedirection(static_cast<int>(code));}
	inline bool isClientError(Code code) {return isClientError(static_cast<int>(code));}
	inline bool isServerError(Code code) {return isServerError(static_cast<int>(code));}
	inline bool isError(Code code) {return isError(static_cast<int>(code));}
	...
	inline std::string getReasonPhrase(Code code) {
		return getReasonPhrase(static_cast<int>(code));
	}
}
